...
void clientCallback(RemoteUIClientCallBackArg a) {
	...
	switch (a.action) {
		...
		case SERVER_DELETED_PRESET: {
			...
			//[me showNotificationWithTitle:@"Server Deleted Preset OK" description:[NSString stringWithFormat:@"%@ deleted preset named '%s'", remoteIP,
			//a.msg.c_str()] ID:@"ServerDeletedPreset" priority:2];
		} break;

		case SERVER_SAVED_PRESET: {
			cout << "SERVER_SAVED_PRESET" << endl;
			//[me showNotificationWithTitle:@"Server Saved Preset OK" description:[NSString stringWithFormat:@"%@ saved preset named '%s'", remoteIP, a.msg.c_str()]
			//ID:@"ServerSavedPreset" priority:2];
		} break;

		case SERVER_DID_SET_PRESET: {
			cout << "SERVER_DID_SET_PRESET" << endl;
			//[me hideAllWarnings];
			//[me showNotificationWithTitle:@"Server Did Set Preset OK" description:[NSString stringWithFormat:@"%@ did set preset named '%s'", remoteIP,
			//a.msg.c_str()] ID:@"ServerDidSetPreset" priority:-1];
		} break;
