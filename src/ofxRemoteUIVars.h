...
#define OFX_REMOTEUI_SERVER_GET_VAR_ADDRESS(type, name) (ofxRemoteUIVars<type>::one().getParam(name))

#define OFX_REMOTEUI_SERVER_GET_VAR(type, name) (*OFX_REMOTEUI_SERVER_GET_VAR_ADDRESS(type, name))

#define OFX_REMOTEUI_SERVER_SET_VAR(type, name, value)                                                                                                         \
	if (type *__tmp_p__ = OFX_REMOTEUI_SERVER_GET_VAR_ADDRESS(type, name)) {                                                                                     \
		(*__tmp_p__) = value;                                                                                                                                      \
	}
